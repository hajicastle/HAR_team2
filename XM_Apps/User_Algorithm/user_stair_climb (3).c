...
#define SWING_FLEXION_END_DEG   45.0f /* 이 각도를 넘으면 다리 들기 토크 끔 */
...
float K_EMG = 2.5f; /* [튜닝 필수] EMG 비례 제어 이득 */
...
static const XmAdcPin_t s_adc_pins[ADC_CH_COUNT] = {
    XM_EXT_ADC_8,   /* CH_FSR_RH: 실제 Right Heel */
    XM_EXT_ADC_7,   /* CH_FSR_RT: 실제 Right Toe */
    XM_EXT_ADC_6,   /* CH_FSR_LH: 실제 Left Heel */
    XM_EXT_ADC_5,   /* CH_FSR_LT: 실제 Left Toe */
    XM_EXT_ADC_9,   /* CH_EMG_R */
    XM_EXT_ADC_10   /* CH_EMG_L */
};
...
XM_SetUsbCustomMeta(
    ...
    "{\"name\":\"EMG_R_Act\",\"unit\":\"-\"},"
    "{\"name\":\"EMG_L_Act\",\"unit\":\"-\"},"
    "{\"name\":\"FSR_RH_Load\",\"unit\":\"-\"},"
    "{\"name\":\"FSR_RT_Load\",\"unit\":\"-\"},"
    "{\"name\":\"FSR_LH_Load\",\"unit\":\"-\"},"
    "{\"name\":\"FSR_LT_Load\",\"unit\":\"-\"},"
    "{\"name\":\"Thigh_R\",\"unit\":\"deg\"},"
    "{\"name\":\"Thigh_L\",\"unit\":\"deg\"},"
    "{\"name\":\"Tau_R\",\"unit\":\"Nm\"},"
    "{\"name\":\"Tau_L\",\"unit\":\"Nm\"},"
    "{\"name\":\"Is_Stair_R\",\"unit\":\"-\"},"
    "{\"name\":\"Is_Stair_L\",\"unit\":\"-\"}"
    "]"
);
